...
public:
  ...
  CDnsSeedOpts() : nThreads(96), nDnsThreads(4), ip_addr("::"), nPort(53), nP2Port(0), nMinimumHeight(0), mbox(NULL), ns(NULL), host(NULL), tor(NULL), fUseTestNet(false), fUseRegTest(false), fWipeBan(false), fWipeIgnore(false), ipv4_proxy(NULL), ipv6_proxy(NULL), magic(NULL) {}

  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Outcoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed-1.outcoin.org", "seed-2.outcoin.org", "seed-3.outcoin.org", ""};
static const string testnet_seeds[] = {"testnet-seed-1.outcoin.org",
